            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-lg bg-component-background p-6 text-left align-middle shadow-xl transition-all">
                ...
                <form onSubmit={handleSubmit(handleFormSubmit)}>
                  ...
                  <div className="mb-4">
                    <label htmlFor="taskDueDateModal" className="block text-sm font-medium text-muted-foreground mb-1">Due Date</label>
                    <input
                      id="taskDueDateModal"
                      type="date"
                      {...register("due_date")}
                  ...
                  {task && task.task_group_id && (
                    <div className="my-4 p-3 bg-secondary/20 border border-border rounded-md">
                      <div className="flex items-center justify-between">
                        <p className="text-sm text-foreground">This task is linked to other tasks.</p>
                        <button
                          type="button"
                      ...
                      <label className="mt-2 flex items-center text-sm text-muted-foreground">
                        <input
                          type="checkbox"
                  ...
                  <div className="flex justify-end space-x-2 mt-6">
                    ...
                    <button type="submit" disabled={isLoading} className="px-4 py-2 bg-primary text-primary-foreground rounded-md disabled:opacity-50">
