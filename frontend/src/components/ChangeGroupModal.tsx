    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-xl max-w-lg w-full">
        ...
        <div className="mb-4 p-4 border rounded-md">
            ...
            <button onClick={handleMoveToExisting} className="w-full bg-blue-500 text-white p-2 rounded-md">Move to Selected Group</button>
        </div>
        ...
        <div className="mb-4 p-4 border rounded-md">
            ...
            <input
                ...
                className="w-full p-2 border border-gray-300 rounded-md mb-2"
            />
            <button onClick={handleCreateAndMove} className="w-full bg-green-500 text-white p-2 rounded-md">Create and Move</button>
        </div>
        
        <div className="mb-4 p-4 border rounded-md">
            <h3 className="font-semibold mb-2">Remove from Group</h3>
            <p className="text-sm text-gray-600 mb-2">This will make the planting independent.</p>
            <button onClick={handleRemoveFromGroup} className="w-full bg-red-500 text-white p-2 rounded-md">Remove from Current Group</button>
        </div>
